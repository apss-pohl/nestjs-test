  ...
  factory: function (require) {
    ...
    (() => {
      ...
      var t = {
          d: (e, o) => {
            for (var r in o)
              t.o(o, r) && !t.o(e, r) && Object.defineProperty(e, r, { enumerable: !0, get: o[r] });
          },
                  ...
                  await n.xfs.mktempPromise(async (o) => {
                    ...
                    await t.startTimerPromise('Copy files', async () => {
                      await (async function ({ destination: t, project: e, report: o }) {
                        ...
                        o.reportInfo(null, r),
                          await n.xfs.copyPromise(n.ppath.join(t, r), n.ppath.join(e.cwd, r), {
                            overwrite: !0,
                          });
                      })({ destination: f, project: e, report: t }),
                        await (async function ({ destination: t, project: e, report: o }) {
                          const r = n.ppath.join(
                            (0, n.toFilename)('.yarn'),
                            (0, n.toFilename)('plugins'),
                          );
                          o.reportInfo(null, r),
                            await n.xfs.copyPromise(n.ppath.join(t, r), n.ppath.join(e.cwd, r), {
                              overwrite: !0,
                        ...
                        await (async function ({
                          ...
                          for (const s of o.storedDescriptors.values()) {
                            const c = r(
                              i.structUtils.isVirtualDescriptor(s)
                                ? i.structUtils.devirtualizeDescriptor(s)
                                : s,
                            );
                            if (!c) continue;
                          ...
                          parseDescriptor: (t) => {
                            if (t.range.startsWith('exec:')) {
                              const e = (function (t) {
                                ...
                                return {
                                  parentLocator:
                                    e && 'string' == typeof e.locator
                                      ? i.structUtils.parseLocator(e.locator)
                                      : null,
                                  path: r,
                                };
                              })(t.range);
                            ...
                            if (t.range.startsWith('patch:')) {
                              const { parentLocator: e, patchPaths: o } =
                                a.patchUtils.parseDescriptor(t);
                              if (!e) return;
                        ...
                        await (async function ({
                          ...
                          for (const i of o.markedFiles) {
                            ...
                            (await n.xfs.existsPromise(i)) &&
                              (r.reportInfo(null, o),
                              await n.xfs.copyPromise(n.ppath.join(t, o), i));
                          }
                    ...
                    for (const e of r) {
                      const o = e.manifest.name
                        ? i.structUtils.stringifyIdent(e.manifest.name)
                        : '';
